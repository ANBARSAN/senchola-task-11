...
function Create() {
  ...
  return (
    <div className='container'>
      <h1 className='text-center text-dark rounded-3 p-2'>Add Employee Details</h1>
      <div>
          ...
          <form onSubmit={handleSubmit} className='mt-3 mx-3'>
            <div className="row">
              <div className="col-12">
                ...
                <input type='text' onChange={e => { setName(e.target.value) }} value={name} className='form-control' placeholder='Employee Name' required></input>
              </div>
              <div className="col-12">
                <label className='form-label ps-2 ' style={{fontWeight:'700'}}>ID </label>
                <input type='text' onChange={e => { setEid(e.target.value) }} value={eid} className='form-control' placeholder='Employee ID' required></input>
              </div>
              <div className="col-12">
              ...
              <div className="col-12">
                ...
                <input type='text-area' onChange={e => { setAddress(e.target.value) }} value={address} className='form-control' placeholder='Employee Address'></input>
              </div>
              <div className="col-12">
                <label className='form-label ps-2 ' style={{fontWeight:'700'}}>Email </label>
                <input type='text' onChange={e => { setEmail(e.target.value) }} value={email} className='form-control' placeholder=' Employee Email'></input>
              </div>
              <div className="col-12">
                <label className='form-label ps-2 ' style={{fontWeight:'700'}}>Mobile No </label>
                <input type='text' onChange={e => { setMobile(e.target.value) }} value={mobile} className='form-control' placeholder='Employee Mobile No'></input>
              </div>
